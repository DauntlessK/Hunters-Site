class ResupplyCustomPopup{
    ...
    subResupplyWithReloadButton() {
        ...
        this.element.addEventListener("click", ()=> {
            ...
            const subResupply = new ResupplyCustomPopup(this.tv, this.gm, this.currentG7a, this.currentG7e, this.current_aftG7a, this.current_aftG7e);
            this.element.remove();
        });
    }
