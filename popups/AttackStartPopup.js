<input type="radio" id="ApproachNow" name="timeofday" value="Approach Now" checked="checked"></input>
<label for="Approach Now">Approach Now</label>
<input type="radio" id="ApproachLater" name="timeofday" value="Wait">
